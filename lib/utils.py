...
def compute_val_loss(net, val_loader, criterion, sw, epoch,eval_random):
    '''
    ...
    with torch.no_grad():
        ...
        for batch_index, batch_data in enumerate(val_loader):
            ...
            # encode
            encoder_output = net.encode(encoder_inputs,eval_random)
            ...
            for step in range(predict_length):
                ...
                predict_output = net.decode(decoder_inputs, encoder_output, eval_random)
...
def predict_and_save_results(net, data_loader, data_target_tensor, epoch, _max, _min, params_path, type,eval_random):
    '''
    for transformerGCN
    :param net: nn.Module
